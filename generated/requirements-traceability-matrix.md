...
| AWG-REQ-UX-APP-001 | The World Explorer review application MUST serve GET-only projections, MUST NOT mutate authoritative world state, and MUST label PMTiles and display clusters as projection-only. | AWG-OPS-001, AWG-UX-001, AWG-GOV-001 | AWG-UX-001 | AWG-TEST-UX-APP-001, AWG-TEST-UX-APP-002 | draft |
| AWG-REQ-WFL-002 | After the review application stage, the workflow loop MUST stop with awaiting_human_review and MUST NOT auto-complete the human_review stage or report plan_complete as human approval. | AWG-OPS-012, AWG-OPS-001 | AWG-OPS-012 | AWG-TEST-WFL-002 | draft |
