---
title: Workspaces, Navigation, Selection, and Context
document_id: AWG-UX-014
status: draft
version: 0.2.0
...
- World, scenario, branch, simulation time, perspective mode, and selected entities remain visible in the global context strip.
