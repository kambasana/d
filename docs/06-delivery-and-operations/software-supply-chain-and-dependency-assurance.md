---
title: Software Supply Chain and Dependency Assurance
document_id: AWG-OPS-011
status: draft
version: 0.2.0
...
- Every shipped dependency and plugin is represented in an SBOM or equivalent inventory.
