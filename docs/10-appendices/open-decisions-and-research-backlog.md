---
title: Open Decisions and Research Backlog
document_id: AWG-APP-002
status: draft
version: 0.2.0
...
This document is informative. Its current status is **draft**. Where this document conflicts with the Simulation Constitution, the Constitution takes precedence.
...
- The implementation must conform to the rules defined in this specification for open decisions and research backlog.
