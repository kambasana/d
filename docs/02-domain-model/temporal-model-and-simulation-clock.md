---
title: Temporal Model and Simulation Clock
document_id: AWG-DOM-008
status: draft
version: 0.2.0
...
- Simulation time is authoritative for world causality and is distinct from wall-clock processing time.
