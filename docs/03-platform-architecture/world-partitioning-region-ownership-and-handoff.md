---
title: World Partitioning, Region Ownership, and Handoff
document_id: AWG-PLAT-011
status: draft
version: 0.2.0
...
- At any simulation instant, one authority owns mutation rights for an entity or partition.
